  ...
  return (
    <div className="md:w-[27.5%] mb-14 md:mb-0">
      <div className={`relative mb-7 lg:mb-16 ${padding}`}>
        ...
        <p className={`relative flex items-center z-10 w-[87%] bg-white rounded-2xl aspect-[7/10] lg:aspect-[9/13] ${picPos}`}><RoundedImg src={src} alt={alt} height="h-full" object={object}/></p>
      </div>
